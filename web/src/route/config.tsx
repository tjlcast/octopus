...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, ShieldAlert } from 'lucide-react';
...
const TrafficControl_Module = lazyWithPreload(() => import('@/components/modules/traffic-control').then(m => ({ default: m.TrafficControl })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'traffic-control', label: '流量控制', icon: ShieldAlert, component: TrafficControl_Module },
